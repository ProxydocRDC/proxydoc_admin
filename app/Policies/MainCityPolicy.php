...
class MainCityPolicy
{
    ...
    {
        return $user->can('view_main::city');
    }
    ...
    {
        return $user->can('delete_any_main::city');
    }
    ...
    {
        return $user->can('force_delete_any_main::city');
    }
    ...
    {
        return $user->can('restore_any_main::city');
    }

    /**
     * Determine whether the user can replicate.
     */
    public function replicate(User $user, MainCity $mainCity): bool
    {
        return $user->can('replicate_main::city');
    }
    ...
    {
        return $user->can('reorder_main::city');
    }
}
