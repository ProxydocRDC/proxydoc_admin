...
class ProxyDoctor extends Model
{
    ...
    public function services()
{
    return $this->belongsToMany(ProxyService::class, 'proxy_doctor_services',
            'doctor_user_id',  // colonne pivot qui référence ProxyDoctor.user_id
            'service_id',      // colonne pivot qui référence ProxyService.id
            'user_id',         // clé locale sur ProxyDoctor
            'id'               // clé locale sur ProxyService
        )
